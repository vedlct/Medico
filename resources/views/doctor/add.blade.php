...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <form enctype="multipart/form-data" id="doctorAddForm" action="{{route('doctor.insert')}}"
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" required name="status" id="doctor_active"
                                   value="{{USER_STATUS['Active']}}" checked>
                            <label class="form-check-label" for="doctor_active">
                                Active
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" required name="status" id="doctor_inactive"
