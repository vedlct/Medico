...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form action="{{ route('appointment') }}" method="post" onsubmit="return validateForm()">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group gender-select">
                                ...
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio"  id="genderMale" name="gender" value="{{GENDER['Male']}}" class="form-check-input">Male
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio"  id="genderFeMale" name="gender" value="{{GENDER['Female']}}" class="form-check-input">Female
                                    </label>
                                </div>
                            </div>
                        </div>
...
{{--                        <button class="btn btn-primary submit-btn">Create Appointment</button>--}}
                        <input type="submit" class="btn btn-primary submit-btn" value="Create Appointment">
